...
exports.seed = function(knex, Promise) {
      ...
      return knex('books').insert([
        {id: 1, title: 'Becoming', author: 1, stockQty: 42, soldqty:310, price: 24.20, 
          ...
          genres: 'biography', issponsored:true, isbn: '978-3-16-148410-1', reviews: 'User1 < Good < 4 < User2 < Well written < 3 < User3 < Didn\'t appreciated it < 2', 
        ...
        {id: 2, title: 'The old man and the sea', author: 2, stockQty: 250, soldqty:744, price: 31.55, 
          ...
          genres: 'travel',issponsored:false, isbn: '978-3-16-148410-2', reviews: 'User1 < Good < 4 < User2 < Well written < 3', 
          description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
        ...
        {id: 3, title: 'Remarkable Creatures', author: 3, stockQty: 0, soldqty:45, price: 12.10, 
          ...
          genres: 'fantasy', issponsored:true, isbn: '978-3-16-148410-3', reviews: 'User1 < Good < 4', 
          description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
        
        {id: 4, title: 'The next 100 years', author: 4, stockQty: 250, soldqty:101, price: 19.33, 
          currency:'€', status: 'available',theme1:'war', 
          genres: 'geopolitical', issponsored:false, isbn: '978-3-16-148410-4', reviews: 'User2 < Well written < 3 < User3 < Didn\'t appreciated it < 2', 
          description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
        ...
        {id: 5, title: 'A song of ice and fire', author: 5, stockQty: 250, soldqty:832, price: 43.70, 
          ...
          genres: 'fantasy', issponsored:true, isbn: '978-3-16-148410-5', reviews: 'User1 < Good < 4 < User2 < Well written < 3 < User3 < Didn\'t appreciated it < 2', 
          description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
        ...
        genres: 'biography', issponsored:false, isbn: '978-3-16-148410-6', reviews: 'User1 < Good < 4 < User2 < Well written < 3 < User3 < Didn\'t appreciated it < 2', 
        description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
        ...
        genres: 'finance', issponsored:false, isbn: '978-3-16-148410-7', reviews: 'User1 < Good < 4 < User2 < Well written < 3 < User3 < Didn\'t appreciated it < 2', 
        description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
      
        {id: 8, title: 'The Testaments', author: 8, stockQty: 250, soldqty:181, price: 22.75, 
        currency:'€', status: 'available',theme1:'courage', 
        genres: 'biography', issponsored:false, isbn: '978-3-16-148410-8', reviews: 'User1 < Good < 4 User2 < Well written < 3 < User3 < Didn\'t appreciated it < 2',
        description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
        ...
        genres: 'biography', issponsored:false, isbn: '978-3-16-148410-9', reviews: 'User1 < Good < 4 < User2 < Well written < 3', 
        description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
        ...
        genres: 'biography', issponsored:false, isbn: '978-3-16-148410-10', reviews: 'User1 < Good < 4', 
        description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
        ...
        genres: 'geopolitical', issponsored:true, isbn: '978-3-16-148410-11', reviews: 'User1 < Good < 4 < User2 < Well written < 3', 
        description: '“Anyone who tries to make a distinction between education and entertainment doesn’t know the first thing about either.”', caption: 'generic description of the book' },
        ...
        genres:'fantasy', issponsored:false, isbn: '978-3-16-148410-12', reviews: 'User1 < As a fan, is very good < 5',
        ...
        genres: 'biography', issponsored:false, isbn: '978-3-16-148410-13', reviews: 'User1 < Good < 4 < User2 < Well written < 3',
